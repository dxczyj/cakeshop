...
<jsp:include page="header.jsp">
	...
	<!--banner-->
		...
		<div class="banner">
			<div class="container">
				<h2 class="hdng"><a href="${pageContext.request.contextPath}/goods_detail?typeid=${scroll.id}">${scroll.name}</a><span></span></h2>
				<p>今日精选推荐</p>
				<a class="banner_a" href="javascript:;" onclick="buy(${scroll.id})">立刻购买</a>
				<div class="banner-text">		
					<a href="${pageContext.request.contextPath}/goods_detail?typeid=${scroll.id}">
				...
				<div class="col-md-4 gallery-grid glry-two">
					...
					<div class="gallery-info galrr-info-two">
						<p>
							...
							<a href="${pageContext.request.contextPath}/goods_detail?typeid=${g.id}">查看详情</a>
						</p>
