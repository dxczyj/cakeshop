            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <c:choose><c:when test="${empty user}">
                        <li><a href="${pageContext.request.contextPath}/user_register.jsp"<c:if test="${param.flag==4}">class="active"</c:if>>注册</a></li>
                        <li><a href="${pageContext.request.contextPath}/user_login.jsp" <c:if test="${param.flag==5}">class="active"</c:if>>登录</a></li>
                    </c:when>
                    <c:otherwise>
                        <li><a href="${pageContext.request.contextPath}/order_list"<c:if test="${param.flag==7}">class="active"</c:if>>我的订单</a></li>
                        <li><a href="${pageContext.request.contextPath}/user_center.jsp"<c:if test="${param.flag==6}">class="active"</c:if>>个人中心</a></li>
