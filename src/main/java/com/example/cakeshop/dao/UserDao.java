...
public class UserDao {
    public void addUser(User user) throws SQLException {
        ...
        r.update(sql,user.getName(),user.getEmail(),user.getPassword(),user.getName(),user.getPhone(),user.getAddress(),user.isIsadmin(),user.isIsvalidate());
    }
    ...
    public void updateUserAddress(User u) throws SQLException {
        QueryRunner r = new QueryRunner(DBUtil.getDataSource());
        String sql = "update user set name = ?,phone = ?,address = ? where id = ?";
        r.update(sql,u.getName(),u.getPhone(),u.getAddress(),u.getId());
    }
    ...
    public void updateUserPassword(User u) throws SQLException {
        QueryRunner r = new QueryRunner(DBUtil.getDataSource());
        String sql = "update user set password = ? where id = ?";
        r.update(sql,u.getPasswordNew(),u.getId());
    }
    ...
    public List selectUserList(int pageNumber, int pageSize) throws SQLException {
        QueryRunner r = new QueryRunner(DBUtil.getDataSource());
