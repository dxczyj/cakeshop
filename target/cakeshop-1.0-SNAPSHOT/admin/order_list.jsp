...
<jsp:include page="/admin/header.jsp"></jsp:include>
         ...
         <tr>
			...
			<td>
				...
				<c:if test="${order.status==3}">
					...
					<a class="btn btn-danger"  href="${pageContext.request.contextPath}/admin/order_delete?id=${order.id}&pageNumber=${page.pageNumber}&status=${status}">删除</a>
	...
	<jsp:include page="../page.jsp">
		...
		<jsp:param name="param" value="&status=${param.status}"/>
	</jsp:include>
	<br>
</div>
</body>
